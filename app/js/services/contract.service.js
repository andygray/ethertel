(function() {
    ...
    function ContractService(web3, ContractConfig, $q, $log) {
            ...
            _.each(abi.function, function(methodAbi) {
                ...
                self[methodAbi.name] = function() {
                    ...
                    if (methodAbi.constant) {
                        ...
                        if (self.batch) {
                            // original contract batch method invocation
                            addToBatch(method.request.apply(method, args), dfd);
                            return self;
                        }
                        else {
                            // original contract method invocation
        ...
        var service = {
            ...
            buildContract: function(cfg, address) {
                var contract = service.load(cfg.abi, address);
        ...
        _.each(ContractConfig, function(cfg, name) {
            if (cfg.address) {
                service[name] = function() {
                    ...
                    console.log("loading: ", name, cfg.address);
